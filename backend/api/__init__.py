...
from api.device.v1.device_measurements import (
    device_measurements_router as device_measurements_v1_router,
)
...
router.include_router(
    device_measurements_v1_router, prefix="/api/v1/devices-measurements", tags=["Devices-Measurements"]
)
router.include_router(devices_v1_router, prefix="/api/v1/devices", tags=["Devices"])
router.include_router(device_reports_v1_router, prefix="/api/v1/devices-reports", tags=["Devices-Reports"])
router.include_router(device_tasks_v1_router, prefix="/api/v1/devices-tasks", tags=["Devices-Tasks"])
